...
Bundler::URI::Parser = Bundler::URI::RFC3986_Parser
...
class Gem::Dependency
  include ::Bundler::ForcePlatform
  include ::Gem::Dependency::FilterIgnoredSpecs
  def force_ruby_platform(); end
...
class Gem::Package::TarReader::Entry
  include ::Gem::FixFullNameEncoding
...
class Gem::Resolver::APISet::GemParser
  include ::Gem::UnfreezeCompactIndexParsedResponse
end
...
module Gem::SecureRandom
  ...
  def self.alphanumeric(n=T.unsafe(nil), chars: T.unsafe(nil)); end
...
module Neo::Color
  def self.black(string); end

  def self.blue(string); end

  def self.clear(string); end

  def self.cyan(string); end
